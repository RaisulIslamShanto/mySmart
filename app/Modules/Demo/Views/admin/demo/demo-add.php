        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0"><?php echo lang('Demo.cat_add'); ?> </h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);"><?php echo lang('Demo.golden_tower'); ?></a></li>
                            <li class="breadcrumb-item active"><?php echo lang('Demo.cat_add'); ?></li>
                        </ol>
                    </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body ">
                        ...
                        <form action="<?php echo base_url() ?>/admin/demo_add" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                            <div class="mb-4">
                                <label><?php echo lang('Demo.category'); ?></label>
